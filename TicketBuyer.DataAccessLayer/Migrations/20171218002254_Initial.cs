    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationDefenitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalePlaces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CancellationId = table.Column<int>(nullable: true),
                    DateTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Cancellations_CancellationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sectors_SectorTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventSales_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationDefenitionId = table.Column<int>(nullable: false),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_NotificationDefenitions_NotificationDefenitionId",
                        column: x => x.NotificationDefenitionId,
                        principalTable: "NotificationDefenitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPreferences_EventTypes_EventTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GiftCertificateId = table.Column<int>(nullable: false),
                    OrderId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftCertificateOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GiftCertificateOrder_GiftCertificates_GiftCertificateId",
                        column: x => x.GiftCertificateId,
                        principalTable: "GiftCertificates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiftCertificateOrder_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventSales_EventId",
                table: "EventSales",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventSales_SaleId",
                table: "EventSales",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_GiftCertificateOrder_GiftCertificateId",
                table: "GiftCertificateOrder",
                column: "GiftCertificateId");

            migrationBuilder.CreateIndex(
                name: "IX_GiftCertificateOrder_OrderId",
                table: "GiftCertificateOrder",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_NotificationDefenitionId",
                table: "Notifications",
                column: "NotificationDefenitionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CancellationId",
                table: "Payments",
                column: "CancellationId",
                unique: true,
                filter: "[CancellationId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPreferences_EventTypeId",
